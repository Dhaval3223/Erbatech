...
// sections
import { getAlarmData } from './slice/action';
...
function AlarmAccess({
  ...
  const { alarmDataLoading, alarmData, checkAlarmData, checkAlarmDataLoading, alarmAcknowledgementDataLoading, alarmAcknowledgementData } = useSelector((state) => state?.alarm);
              ...
              <Table size="small" sx={{ minWidth: 800 }}>
                ...
                <TableBody>
                  {isSensorLoading ? (
                    ...
                    alarmData?.rows?.map((row: any, index: any) => (
                      <AlarmRows
...
export default function Alarm() {
  ...
  return isView ? (
    <AlarmAccess isUpdateRights={isUpdate} />
  ) : (
    <Page403 />
  );
}
