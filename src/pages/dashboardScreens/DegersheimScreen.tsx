  ...
  return (
    ...
    >
      <defs>
        ...
        <mask id="mask226" width="1" height="1" x="0" y="0" maskUnits="userSpaceOnUse">
          <image
            width="1"
            height="1"
            imageRendering="optimizeSpeed"
        ...
        <mask id="mask242" width="1" height="1" x="0" y="0" maskUnits="userSpaceOnUse">
          <image
            width="1"
            height="1"
            imageRendering="optimizeSpeed"
        ...
        <mask id="mask836" width="1" height="1" x="0" y="0" maskUnits="userSpaceOnUse">
          <image
            width="1"
            height="1"
            imageRendering="optimizeSpeed"
      ...
      <g transform="matrix(1.33333 0 0 -1.33333 0 720)">
        ...
        <path
          ...
          fillRule="evenodd"
          stroke="none"
          d="M554.16 325.03c0 5.26 4.27 9.53 9.53 9.53h359.9c5.26 0 9.53-4.27 9.53-9.53V82.133c0-5.265-4.27-9.533-9.53-9.533h-359.9c-5.26 0-9.53 4.268-9.53 9.533z"
        />
        <path
          fill="none"
          stroke="#ffc000"
        ...
        <path
          ...
          fillRule="evenodd"
          stroke="none"
          d="M28.2 326.35c0 4.01 3.245 7.25 7.247 7.25H543.79c4.01 0 7.25-3.24 7.25-7.25V79.967a7.245 7.245 0 00-7.25-7.247H35.447a7.248 7.248 0 00-7.247 7.247z"
        />
        <g>
        ...
        <path
          ...
          fillRule="evenodd"
          stroke="none"
          d="M237.6 307.56h48.12v12.48H237.6z"
        />
        <path
          fill="none"
          stroke="#2f528f"
        ...
        <g>
          <g clipPath="url(#clipPath356)">
            <text
              ...
              fontVariant="normal"
              fontWeight="normal"
              transform="matrix(1 0 0 -1 248.88 310.75)"
              writingMode="lr-tb"
            >
              <tspan x="0" y="0">
                {apiValues?.[keys?.[3.2]] &&
        ...
        {/* <g>
          <g clipPath="url(#clipPath368)">
            <text
              ...
              fontVariant="normal"
              fontWeight="normal"
              transform="matrix(1 0 0 -1 266.64 310.75)"
              writingMode="lr-tb"
            >
              <tspan x="0" y="0">
                °
        ...
        <g>
          <g clipPath="url(#clipPath380)">
            <text
              ...
              fontVariant="normal"
              fontWeight="normal"
              transform="matrix(1 0 0 -1 269.64 310.75)"
              writingMode="lr-tb"
            >
              <tspan x="0" y="0">
                C
        ...
        <path
          ...
          fillRule="evenodd"
          stroke="none"
          d="M179.88 307.56H228v12.48h-48.12z"
        />
        <path
          fill="none"
          stroke="#2f528f"
        ...
        {/* <g>
          <g clipPath="url(#clipPath408)">
            <text
              ...
              fontVariant="normal"
              fontWeight="normal"
              transform="matrix(1 0 0 -1 208.94 310.75)"
              writingMode="lr-tb"
            >
              <tspan x="0" y="0">
                °
        ...
        <g>
          <g clipPath="url(#clipPath420)">
            <text
              ...
              fontVariant="normal"
              fontWeight="normal"
              transform="matrix(1 0 0 -1 211.94 310.75)"
              writingMode="lr-tb"
            >
              <tspan x="0" y="0">
                C
        ...
        <path
          ...
          fillRule="evenodd"
          stroke="none"
          d="M209.52 273.36h48.24v12.6h-48.24z"
        />
        <path
          fill="none"
          stroke="#2f528f"
        ...
        <g>
          <g clipPath="url(#clipPath436)">
            <text
              ...
              fontVariant="normal"
              fontWeight="normal"
              transform="matrix(1 0 0 -1 226.39 276.62)"
              writingMode="lr-tb"
            >
              <tspan x="0" y="0">
        ...
        <path
          ...
          fillRule="evenodd"
          stroke="none"
          d="M209.52 290.52h48.24V303h-48.24z"
        />
        <path
          fill="none"
          stroke="#2f528f"
        ...
        <g>
          <g clipPath="url(#clipPath452)">
            <text
              ...
              fontVariant="normal"
              fontWeight="normal"
              transform="matrix(1 0 0 -1 221.23 293.69)"
              writingMode="lr-tb"
            >
              <tspan x="0" y="0">
                {apiValues?.[keys?.[3.4]] &&
        ...
        {/* <g>
          <g clipPath="url(#clipPath464)">
            <text
              ...
              fontVariant="normal"
              fontWeight="normal"
              transform="matrix(1 0 0 -1 234.91 296.45)"
              writingMode="lr-tb"
            >
              <tspan x="0" y="0">
                3
        ...
        <g>
          <g clipPath="url(#clipPath476)">
            <text
              ...
              fontVariant="normal"
              fontWeight="normal"
              transform="matrix(1 0 0 -1 237.91 293.69)"
              writingMode="lr-tb"
            >
              <tspan x="0 3.48" y="0">
                /h
        ...
        <g>
          <g clipPath="url(#clipPath774)">
            ...
            >
              <tspan x="0" y="0">
                {apiValues?.T_tank_1 && `${roundToOneDecimalPlace(apiValues?.T_tank_1)} °C`}
              </tspan>
            </text>
          </g>
        </g>
        ...
        <path
          fill="none"
          stroke={
            apiValues?.Enable_WP == 0 ? '#36B37E' : apiValues?.Enable_WP == 0 ? 'red' : '#000'
          }
          strokeDasharray="none"
          strokeLinecap="butt"
          strokeLinejoin="miter"
          strokeMiterlimit="10"
          strokeOpacity="1"
          strokeWidth={apiValues?.Enable_WP == 0 || apiValues?.Enable_WP == 0 ? '3' : '0.96'}
          d="M603.24 114h75.72v73.32h-75.72z"
        />
        <path
          fill="none"
        ...
        <g>
          <g clipPath="url(#clipPath1188)">
            <text
              ...
              fontVariant="normal"
              fontWeight="normal"
              transform="matrix(1 0 0 -1 508.08 148.15)"
              writingMode="lr-tb"
            >
              <tspan x="0" y="0">
        ...
        {/* <g>
          <g clipPath="url(#clipPath1826)">
            <text
              ...
              fontVariant="normal"
              fontWeight="normal"
              transform="matrix(1 0 0 -1 402.1 179.45)"
              writingMode="lr-tb"
            >
              <tspan x="0" y="0">
                3
        ...
        <g>
          <g clipPath="url(#clipPath1838)">
            <text
              ...
              fontVariant="normal"
              fontWeight="normal"
              transform="matrix(1 0 0 -1 405.1 176.69)"
              writingMode="lr-tb"
            >
              <tspan x="0 3.48" y="0">
                /h
