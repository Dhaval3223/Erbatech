...
// sections
import UserTableRow from './TemplateCreationEow';
// import { deleteUserById, getAllUsers, viewUserById } from './slice/action';
import UserTableToolbar from './TemplateCreationTableToolbar';
...
import AddTemplates from './models/AddTemplates';
import { deleteTemplateById, getAllUsers, viewAllTemplate } from '../user/slice/action';
// ----------------------------------------------------------------------
...
const TABLE_HEAD = [
  { id: 'dashboard name', label: 'Dashboard Name', align: 'left' },
  { id: 'customer name', label: 'Customer Name', align: 'left' },
  { id: 'date of mapping', label: 'Date Of Mapping', align: 'left' },
  { id: 'Topic-send', label: 'Topic-send', align: 'left' },
  { id: 'Topic-receive', label: 'Topic-receive', align: 'left' },
  { id: 'Topic-alerm', label: 'Topic-alerm', align: 'left' },
...
function UserListing({ user, isUpdateRights, isDeleteRights, isCreateRights }: IUserListing) {
  ...
  const { isUserLoading, users, deleteTemplateMsg, deleteTemplateError, deleteTemplateSuccess } =
    useSelector((state) => state.user);
  console.log('isUserLoading', isUserLoading, users);
  ...
  }, [page, rowsPerPage, dispatch, filterName, user, hitApi]);
  ...
  useEffect(() => {
    if (deleteTemplateSuccess) {
      ...
      dispatch(slice.actions.resetDeleteTemplateById());
    }
  ...
  }, [deleteTemplateSuccess, deleteTemplateError]);
      ...
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <Card>
          <UserTableToolbar
            ...
            createButtonLable="+ add template"
